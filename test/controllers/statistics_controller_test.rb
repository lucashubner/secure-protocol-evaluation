...
class StatisticsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create statistic" do
    assert_difference('Statistic.count') do
      post statistics_url, params: { statistic: { protocol_type_id: @statistic.protocol_type_id, value: @statistic.value } }
    end
  ...
  test "should update statistic" do
    patch statistic_url(@statistic), params: { statistic: { protocol_type_id: @statistic.protocol_type_id, value: @statistic.value } }
